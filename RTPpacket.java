...
public class RTPpacket {
    ...
    public RTPpacket(int PType, int Framenb, int Time, byte[] data, int data_length) {
        ...
        header[1] = (byte) (Marker << 7 & 0x8F);
        header[1] |= (byte) (PayloadType & 0x7F);
        header[2] = (byte) (SequenceNumber >> 8);
        header[3] = (byte) (SequenceNumber & 0xFF);
        header[4] = (byte) (TimeStamp >> (8 * 3));
        header[5] = (byte) (TimeStamp >> (8 * 2));
        header[6] = (byte) (TimeStamp >> (8 * 1));
        header[7] = (byte) (TimeStamp & 0xFF);

        /* SSRC Abitrário */
        header[8] = (byte) (TimeStamp >> (8 * 3));
        header[9] = (byte) (TimeStamp >> (8 * 2));
        header[10] = (byte) (TimeStamp >> (8 * 1));
